...
const Sidebar = ({ isOpen, setIsOpen }) => {
  ...
  return (
    <aside className="fixed top-0 left-0 h-full w-[260px] bg-[#f9f7f0] z-50 hidden md:flex flex-col border-r border-[#e8e3d5]">
          ...
          return (
            <div key={category.title} className="mb-2">
              ...
              >
                ...
                <div style={{ transform: isSectionOpen ? 'rotate(180deg)' : 'rotate(0deg)', transition: 'transform 0.2s' }}>
                  <ChevronDown size={16} />
                </div>
              </button>

              {isSectionOpen && (
                <ul className="bg-white/40 overflow-hidden">
